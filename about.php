    ...
    <div class="okvir">
        ...
        <div id="abt-okvir">
            <div class="rezime">
                <div class="left">
                    <div class="img">
                        <img src="images/ja.jpg" alt="Aleksandar Naumovic"/>
                    </div>
                            ...
                            <ul>
                                <li>
                                    <div class="li_wrap">
                                        ...
                                        <div class="text">555 555555</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="li_wrap">
                                        <div class="icon"><i class="far fa-envelope"></i></div>
                                        <div class="text">corleoneqq@gmail.com</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="li_wrap">
                                        <div class="icon"><i class="fab fa-weebly"></i></div>
                                        <div class="text">www.gamingstore.com</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="li_wrap">
                                        <div class="icon"><i class="fas fa-map-signs"></i></div>
                                        <div class="text">Karadjordjeva 55, Srbija</div>
                                    </div>
                                </li>
                            </ul>
                        </div>
